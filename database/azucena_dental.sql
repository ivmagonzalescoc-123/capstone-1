...
(4, '2026-01-18', '11:00:00', NULL, 1, 1, '2026-01-18 14:48:25', NULL, 1, 3, NULL, NULL, NULL);
...
--
ALTER TABLE `selected_services`
  MODIFY `selected_service_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tooth_records`
  MODIFY `tooth_record_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
